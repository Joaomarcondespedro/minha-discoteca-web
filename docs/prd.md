...
* **US04:** Como **Colecionador**, quero **excluir um álbum da minha biblioteca**, para que **meu catálogo reflita apenas as mídias que ainda possuo**.
* **US05:** Como **Colecionador**, quero **adicionar e remover discos de uma Fila de Reprodução/Favoritos**, para que **eu possa separar rapidamente o que quero ouvir no momento**.
